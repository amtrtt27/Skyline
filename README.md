...
🌇 SKYLINE
An AI-Driven Platform for Sustainable, Transparent Post-Disaster Reconstruction
SKYLINE is an end-to-end software platform designed to transform post-disaster rubble into actionable rebuilding resources. By integrating AI-powered damage assessment, ontology-based material reuse, and transparent procurement workflows, SKYLINE accelerates recovery while embedding circular-economy principles into reconstruction.

🚧 Problem Statement
Large-scale disasters and conflicts generate massive amounts of damaged buildings and construction debris. While modern computer vision can estimate damage and debris volume, current reconstruction workflows remain fragmented:
...
SKYLINE addresses this gap by converting damage data directly into decision-ready reconstruction actions 
